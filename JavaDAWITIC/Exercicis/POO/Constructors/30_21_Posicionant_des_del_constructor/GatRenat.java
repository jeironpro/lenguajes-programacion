...
Ja sabem que la immutabilitat és una propietat desitjable en algunes ocasions, així que, en aquest exercici la mantindrem una mica més.

Encara hi ha una altra cosa que et pot sorprendre d'aquest codi: defineix el mètode toString(). El mètode toString() permet definir quina representació té la instància quan calgui convertir-la a String. Per exemple, System.out.println(renat.toString()) és equivalent a simplement fer System.out.println(renat). Una sorpreseta més de les que ens té preparades aquest meravellós llenguatge!

Per que això funcioni, és necessari escriure exactament toString() i no alguna altra cosa similar com ara tostring() o aString(). Per assegurar-nos que ho hem escrit bé, afegim @Override davant de la definició. Es tracta del que es coneix com una anotació i, en posar-ho, el compilador es queixarà si escrivim malament el nom del mètode.
Què haig de fer
